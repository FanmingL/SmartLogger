...
BAR_MARK_MAXIMUM_WITH_STAT = False
DESCRIPTION['BAR_MARK_MAXIMUM_WITH_STAT'] = '基于显著性标星 (True, False)'
FLEXIBLE_CONFIG['BAR_MARK_MAXIMUM_WITH_STAT'] = dict(SAME_XY=True, SAME_TITLE=True, SUB_IMAGE=True)
...
TABLE_BOLD_MAX = True
DESCRIPTION['TABLE_BOLD_MAX'] = '表格是否加粗最高值 (True, False)'
FLEXIBLE_CONFIG['TABLE_BOLD_MAX'] = dict(SAME_XY=True)

TABLE_SHOW_AVERAGE = False
DESCRIPTION['TABLE_SHOW_AVERAGE'] = '表格数据为所有数据点的平均 (True, False)'
FLEXIBLE_CONFIG['TABLE_SHOW_AVERAGE'] = dict(SAME_XY=True, SAME_TITLE=True, SUB_IMAGE=True)
...
PLOTTING_USE_CACHE = False
DESCRIPTION['PLOTTING_USE_CACHE'] = '使用缓存绘图'

AUTO_PLOTTING_CACHE_UPDATE = False
DESCRIPTION['AUTO_PLOTTING_CACHE_UPDATE'] = '自动更新绘图缓存'
...
PLOTTING_AUTO_REFRESH_PAGE = False
DESCRIPTION['PLOTTING_AUTO_REFRESH_PAGE'] = '自动刷新图片'
